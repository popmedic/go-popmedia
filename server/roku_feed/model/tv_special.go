...
/*
TvSpecials an array of TvSpecial objects
*/
type TvSpecials []TvSpecial

/*
TvSpecial object of root property tvSpecials
*/
type TvSpecial struct {
	...
	ExternalIDs ExternalIDs `json:"extrenalIds"`
}
